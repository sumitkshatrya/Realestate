...
//     emailjs
//       .sendForm("service_ef8ytjz", "template_o2i1swg", form.current, {
//         publicKey: "X5lAVIVNBeHqQtEva",
//       })
//       .then(
//         () => {
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_x6ozsif","template_titjvxe", form.current, {
        publicKey: "-yQg1pgwKo4bif8Jx",
      })
      .then(
        () => {
    ...
    <div className={`${darkMode ? "bg-gray-900" : "bg-white"} pb-20`}>
      ...
      >
        ...
        >
          ...
          <form ref={form} onSubmit={sendEmail} className="w-full space-y-4">
            <input
              ...
              name="user_name"
              placeholder="Enter your full name here"
              className="w-full px-6 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-blue-500"
              required
            />
            <input
              type="email"
            ...
            <textarea
              name="message"
              placeholder="Enter your message here...."
              className="w-full px-6 py-3 border-2 border-gray-300 rounded-xl resize-none focus:outline-none focus:border-blue-500"
              rows="5"
              required
            ></textarea>
            ...
            <button
              type="submit"
              className={`w-full text-lg py-4 px-8 rounded-xl font-semibold cursor-pointer transition-colors mt-4 ${
                darkMode
                  ? "bg-red-600 hover:bg-black text-white"
        ...
        <div className="flex flex-col justify-center items-start gap-8 lg:p-10 p-6">
          ...
          <button
            className={`text-md py-3 px-8 rounded-xl font-semibold cursor-pointer ${
              darkMode
                ? "bg-red-600 hover:bg-black text-white"
                : "bg-blue-500 hover:bg-black text-white"
            }`}
